...
ip_name_configuration_tests = load_tests(os.path.join(test_data_path, 'password_options.yaml'))
...
def test_ossec_authd_password_options(get_configuration, configure_environment, configure_sockets_environment):
