...
ip_name_configuration_tests = load_tests(os.path.join(test_data_path, 'force_options.yaml'))
...
def test_ossec_authd_force_options(clean_client_keys_file, write_keys, get_configuration, configure_environment, configure_sockets_environment):
    ...
    override_wazuh_conf(get_configuration, None)
