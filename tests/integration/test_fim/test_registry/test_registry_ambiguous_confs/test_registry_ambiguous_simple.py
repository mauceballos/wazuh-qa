...
def test_ambiguous_tags(key, sub_keys, arch, skip_fim_scheduled_cloud_windows, get_configuration, configure_environment,
...
def test_ambiguous_recursion(key, subkey, arch, get_configuration, configure_environment, 
                             skip_fim_scheduled_cloud_windows, restart_syscheckd, wait_for_fim_start):
    '''
