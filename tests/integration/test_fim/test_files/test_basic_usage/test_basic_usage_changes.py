...
mark_skip_agentWindows = pytest.mark.skipif(sys_platform != 'Linux' and sys_platform!= 'solaris' and sys_platform!= 'darwin', reason="It will be blocked by wazuh/wazuh-qa#2174")
